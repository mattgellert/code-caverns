  ...
  render() {
    return (
      <div className="editor-wrapper">
        ...
        <button className="editor-button" onClick={this.onRun}>Run</button>
        {this.props.challenge.pass ? <button className="editor-button" onClick={this.onQuit}>Continue!</button> : <button className="editor-button" onClick={this.onQuit}>Quit</button>}
      </div>
    );
  };
};
